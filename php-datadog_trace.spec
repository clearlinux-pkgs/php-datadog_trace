...
Source0  : https://pecl.php.net/get/datadog_trace-0.98.1.tgz
...
%prep
%setup -q -n datadog_trace-0.98.1
cd %{_builddir}/datadog_trace-0.98.1
pushd ..
cp -a datadog_trace-0.98.1 buildavx2
popd
