...
Source0  : https://pecl.php.net/get/datadog_trace-0.97.0.tgz
...
%prep
%setup -q -n datadog_trace-0.97.0
cd %{_builddir}/datadog_trace-0.97.0
pushd ..
cp -a datadog_trace-0.97.0 buildavx2
popd
